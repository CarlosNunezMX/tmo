  ...
  return (
    <header className="flex flex-row p-2 items-center gap-2">
      ...
      <h1 className="font-bold flex items-center gap-2">
        ...
        <a href="https://github.com/CarlosNunezMX/tmo" className="text-xs font-medium border rounded px-2 py-1 dark:hover:bg-zinc-600 dark:bg-zinc-900 dark:border-zinc-600 ">
          TMobile
        </a>
      </h1>
    </header>
